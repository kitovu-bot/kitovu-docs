...
\begin{description}
\item[Nicolas Ganz] FIXME Nicolas
...
\item[Méline Sieber] FIXME Meline Ausbau der Python-Programmierfähigkeiten und -kenntnisse (keine grosse Erfahrung vorhanden); erstes komplexeres Softwareprojekt durchziehen; Test-Erfahrung sammeln
...
FIXME Meline Abgrenzung HSR Connect 1: Gui, Plattformunabhängig, modular statt gebastel, wird innerhalb strukturiertem Softwareprojekt gebaut
...
FIXME Nicolas schaut in vorhandene Vorlagen
...
\item[Florian Bruhin] \strut \\[-1em]
  \begin{itemize}
    \item Product Owner: gesamt Überblick über die Ziele; Priorisierung der Tasks
    \item QA Supervisor: prüfen von Test-Coverage, Test-Qualität und Linting; evt. bad practices erkennen (duplizierter Code)
    \item UI-Programmierung
  \end{itemize}
\item[Nicolas Ganz] \strut \\[-1em]
  \begin{itemize}
    \item Scrum Master: "Coach" des Scrum-Teams; einhalten von Scrum; Scrum-Sitzungen vorbereiten und leiten
    \item JIRA/Confluence System-Admin
    \item Zeitbuchungs-Überwacher/-in: hat den Überblick von erledigtem Aufwand, noch offenem Aufwand und verbleibender Zeit
    \item Code-Writer
  \end{itemize}
...
\item[Méline Sieber] \strut \\[-1em]
  \begin{itemize}
    \item Lektorin: gegenlesen und korriegeren sämtlicher Dokumente
    \item Verantwortlich für Code- und User-Dokumentation mit Sphinx
    \item Protokolliererin: Protokolle sämtlicher Sitzungen erstellen
...
\begin{tabular}{llp{8em}lllp{8em}p{15em}}
  \toprule
