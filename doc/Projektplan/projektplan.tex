...
\author{
  ...
  Marco Zollinger\footnote{War ursprünglich Mitglied, aufgrund eines nicht bestandenen Basispflichtmoduls musste er das Team leider verlassen. Er wird deswegen im restlichen Dokument nicht mehr aufgeführt.} \\ \url{marco.zollinger@hsr.ch}}
\date{\today}
...
Somit fällt also ein totaler Aufwand von $3 \cdot 120 = 360$ Stunden an.
...
\hline
9  & 2 & \textbf{M1: Projektplan} & & Elaboration \\
...
\hline
14 & 7 & & Review End of Elaboration & Construction \\
15 & 8 & & & \\
16 & 9 & & & \\
...
\begin{ganttchart}[
  ...
  \gantttitle{\hspace{-6.5em}\footnotesize{Kalenderwoche}}{0}{0}
  \gantttitlelist{8,...,22}{1} \\
  \gantttitle{\hspace{-6.5em}\footnotesize{Semesterwoche}}{0}{0}
  \gantttitlelist{1,...,15}{1} \\

  \ganttmilestone{M0: Projektantrag}{1} \\

  \ganttgroup{Elaboration}{2}{6} \\

  \ganttbar{Projektplan erstellen}{2}{2} \\
  \ganttmilestone{M1: Projektplan}{2} \\
  \ganttbar{Requirements erstellen}{3}{3} \\
  \ganttmilestone{M2: Requirements}{3} \\
  \ganttbar{Training}{4}{4} \\
  \ganttbar{Architekturprototyp}{5}{5} \\
  \ganttbar{Puffer}{6}{6} \\
  \ganttmilestone{M3: End of elaboration}{6} \\

  \ganttgroup{Construction}{7}{13} \\
  \ganttbar{Grundfunktionalität}{7}{9} \\
  \ganttbar{Optionale Features / Puffer}{10}{10} \\
  \ganttmilestone{M4: Architektur}{10} \\

  \ganttbar{Usability-Tests durchführen}{11}{11} \\
  \ganttmilestone{M5: Usability-Test}{11} \\
  \ganttbar{Verbleibende Features}{12}{12} \\
  \ganttbar{Puffer}{13}{13} \\
  \ganttgroup{Feature freeze}{14}{15} \\
  \ganttmilestone{M6: Feature Freeze}{13} \\
  \ganttbar{Bugfixes/Abschluss}{14}{15} \\
  \ganttmilestone{M7: Projektabschluss}{15}
...
Da Méline und Nicolas noch Python-Anfänger sind und es auch eines der
...
\begin{tabulary}{\linewidth}{lLlL}
  ...
  Nr & Beschreibung & Dauer & End-Resultat \\
  \midrule
  3-1 & Projektabschluss & 2 Wochen & Sämtliche Dokumente und Abgabematerialien \\
  \bottomrule
\end{tabulary}
...
\item Gemeinsame Arbeit, nach Bedarf: Florian Bruhin und Méline Sieber, Freitag ab 15 Uhr (in KW 9, 11, 14, 16, 18, 20, 22).
\item Arbeit am Projekt: Florian Bruhin, Montag-Nachmittag ab 13 Uhr.
\end{itemize}
...
Wir haben in jeder Phase Pufferphasen eingeplant. Sollten diese nicht benötigt
werden, können wir das Projekt in dieser Zeit mit optionalen Anbindungen
(Moodle/Studentenportal) bzw. Features erweitern.
