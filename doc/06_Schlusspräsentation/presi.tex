...
\begin{document}
  ...
  \begin{frame}
    ...
    \includegraphics[width=\linewidth]{../End_of_Elaboration/img/kontextdiagramm.png}
  ...
  \begin{frame}
    ...
    \includegraphics[height=0.9\textheight]{../End_of_Elaboration/img/GrobesSequenzDiagramm.pdf}
  \end{frame}
