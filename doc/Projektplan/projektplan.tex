...
FIXME tabelle linksbündig ausrichten
...
\section{Einführung}
\subsection{Zweck}
Der Projektplan zu \emph{kitovu} gibt eine Vogelperspektive zum Engineering-Projekt. Er steckt den Rahmen ab, innerhalb dessen \emph{kitovu} vollendet wird. Dieses Dokument umfasst eine Projektübersicht, detailliert, wie das Projekt organisiert ist, welche Phasen das Projekt durchläuft und wie die Besprechungen mit dem Betreuer organisiert sind. Zudem bespricht der Projektplan mögliche Risiken, umreisst die anstehenden Arbeitspakete und listet die wichtigen Punkte, um eine entsprechende Qualität des Codes, der Dokumentation und des Projekt-Managements zu garantieren.
...
\begin{description}
\item[Nicolas Ganz]
  Mein Ziel ist es, mit dem Aufbau dieses Projektes von Grundauf, Erfahrungswerte, was die Organisation und das Management eines Projektes anbelangt, zusammeln.
  Zusätzlich möchte Erfahrungen mit Python und dessen Tools und Libraries sammeln.
...
\item[Méline Sieber] Verbessern der Python-Programmierfähigkeiten und -kenntnisse (nur Grundkenntnisse vorhanden); erstes komplexeres Softwareprojekt durchziehen und entsprechende Arbeitsschritte und Werkzeuge kennenlernen; Erfahrung im Test-Driven-Development sammeln.
...
FIXME mehr auflisten als nur das, was das Projekt kann. Wir müssen auch schreiben, was sonst noch abgeliefert wird.
...
FIXME: tabelle linksbündig ausrichten, keine Blöcke
\begin{tabular}{llll}
\toprule
