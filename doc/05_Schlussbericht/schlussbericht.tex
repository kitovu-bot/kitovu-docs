...
\paragraph{Code-Regeln setzen}
 Wir setzten uns selber hohe Hürden, bis es Code in den Master-Branch schaffte: Pull-Requests, dann Code-Review eines Teammitglieds; gleichzeitig  Style-Prüfung mit Mypy, Flake8 und Pylint. Erst wenn der Code all diese Prüfungen passiert hatte, wurde er Teil des Masters. Das führte zu sauberem, gut wartbarem Code.
...
Dank dieser Aufgabe erreichte ich endlich die Programmierroutine, die ich mir zu Projektbeginn selber als Ziel gesetzt hatte. Des Weiteren wurde mir klar, wie wichtig Tests sind: Diese ermöglichten mir zu verstehen, wie Code funktioniert, den ich nicht selber geschrieben habe.
...
komplizierteren Dingen zu haben. Gerade in Open-Source-Projekten ist sowas besonders zu Beginn nicht möglich. Ich habe gemerkt, wie wertvoll es ist, sich
...
Ich bin mir Ruby gewohnt, was grundsätzlich ähnlich zu Python ist, sich aber doch in diversen Kleinigkeiten unterscheidet.
...
Bemerkenswert ist die Spitze in der zweiten Woche: Hier investierten wir besonders viel Zeit für den Projektplan.
...
zentral waren und verschiedene Anbieter umspannen. Es sind keine solchen
...
\verb|coala|, welches Probleme von Code-Style-Checkern direkt in
...
Engineering-Projekts umgesetzt wurden. Es ist geplant, diese Aufgaben zu
...
\includegraphics[width=0.5\linewidth]{./img/screenshots/gui3.png} \\[1em]
...
\begin{enumerate}
	...
	\item \verb|$ virtualenv -p python3.6 kitovu| \newline
