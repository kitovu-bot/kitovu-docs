...
\emph{Kitovu} ist ein Software-Client für HSR-Studentinnen -Studenten, mit dem sie von verschiedenen Quellen Unterrichtsmaterialien auf den eigenen Rechner synchronisieren können.
...
Elaboration''-Modell, wobei wir eine zusätzliche Trainingsiteration hinzufügen (siehe unten). Eine Iteration dauert in der Regel eine Woche dauern.
...
Das Projekt ist in 8 Meilensteine eingeteilt, welche im JIRA in Form von ''Epics'' sind, sämtliche weitere Tickets sind gruppiert.
...
werden funktionierende Änderungen eingepflegt, in \verb|feature/hotfix|-Branches arbeiten wir an allen Änderungen.
...
\begin{description}
  ...
  \item[Green]
    ...
    Es muss noch nicht schöner Code sein, sonder der Test muss einfach erfolgreich sein.
  \item[Refactor]
