...
%	 		\column[placement]{column width}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\end{itemize}
		\end{itemize}
	\pnote{* Fokus darauf, Ablauf der Software-Entwicklung lernen}
...
\begin{center}
	...
	\begin{frame}
		...
		%FIXME Nicolas sagt was kurz zur Zeiterfassung
			\pnotes{NEXT UP: Méline}
	\end{frame}
