...
\item[Nicolas Ganz] \strut \\[-1em]
  \begin{itemize}
    \item Scrum Master: Er coached das Scrum-Teams, unter anderem mit dem sicherstellen, dass Scrum eingehalten wird und dem Vorbereiten und Leiten der Scrum-Sitzungen.
...
\item[Méline Sieber] \strut \\[-1em]
  \begin{itemize}
    \item Lektorin: Sie liest die Dokumente gegen und korrigiert diese wo nötig.
...
In diesem Meilenstein werden wir die Tests von aussenstehenden Personen durchführen.
...
benutzen. Momentan ist noch offen, welche Bibliothek dazu genau genutzt werden
...
Diese testen nicht die Komponenten selbst, sondern die eigentliche Anwendung des Benutzers.
...
Das bedeutet, dass wir bei der Umsetzung eines Features oder beheben eines Fehlers folgende Schritte durchlaufen werden:
