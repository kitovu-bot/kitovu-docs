...
\begin{description}
	...
	\item[Informatikkenntnisse] Als ehemaliger Grafiker ist Reto Schmid bestens mit MacOS vertraut, kennt Photoshop und Illustrator im Schlaf. Doch an der HSR wird primär Windows verwendet. Seit er sich um seine Kinder kümmert, verwendet er den Computer primär, um zu mailen, Youtube-Videos zu gucken und Rezepte zu googlen.
