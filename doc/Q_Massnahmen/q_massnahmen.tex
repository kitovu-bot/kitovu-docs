...
\begin{document}
  ...
  \begin{enumerate}
    \item Lösche Dateien früherer Tests.
  ...
  \begin{enumerate}
    \item Lösche Dateien früherer Tests. Dateien löschen, falls vorhanden.
