...
Eigentlich bin ich kein Fan von Gruppenarbeiten -- in der Vergangenheit
zeigte sich oft, dass ich in einer Gruppe die treibende Kraft war. Dadurch wird
die Gruppe durch den Zusatzaufwand für die Kommunikation untereinander oft eher
zu einem Last als zu einer Erleichterung.

Eigentlich würde ich mich dadurch eher als einen Einzelkämpfer bei grösseren
Arbeiten bezeichnen -- auch bei meinem
...
gelohnt, von Anfang an das entsprechende ``Tooling'' (Travis CI, style checker,
...
nicht zu viel vorzunehmen, und uns den Lerneffekt des ganzen Projektes als eines
der Hauptziele auf die Fahnen zu schreiben. Unser Projekt ist im Umfang etwas
unter dem Durchschnittsprojekt, aber wir waren uns einig, dass wir lieber auf
Qualität als auf Quantität setzen.

Ich habe von Kollegen gehört, ich hätte (mit der entsprechenden
Software-Engineering-Erfahrung durch meine Arbeit an Open-Source-Projekten) wohl
nicht mehr viel neues beim Engineering-Projekt gelernt. Diese Aussage kann ich
so definitiv nicht stehen lassen. Es ist wohl etwas dran, dass aus technischer
Sicht Méline und Nicolas wohl mehr neues Wissen aufgenommen haben wie ich --
wobei ich auch da bewusst einige mir unbekannte Tools eingesetzt habe (mypy und
Pipenv), die ich nun besser kenne und auch selbst für andere Projekte verwenden
will.
